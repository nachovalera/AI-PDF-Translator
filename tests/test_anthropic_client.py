"""Tests for ai_pdf_translator.anthropic_client singleton."""
...
import ai_pdf_translator.anthropic_client as client_mod
...
class TestGetClient:
    ...
    def test_returns_client_instance(self, monkeypatch):
        ...
        with patch.object(client_mod, "anthropic") as mock_anthropic:
